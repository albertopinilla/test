...
<html lang="en">
  <head>
    ...
    <title>Sistema de inventaio y ventas</title>
    <!-- CSS files -->
          ...
          <div class="navbar navbar-light">
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item {{ Route::current()->getName() == 'productos.index' || Route::current()->getName() == 'productos.create' ? 'active' : '' }}">
                ...
                <li class="nav-item {{ Route::current()->getName() == 'ventas.index' ? 'active' : '' }}">
